...
if (AIRTABLE_PAT.includes("PEGAR") || SUPABASE_URL.includes("PEGAR")) {
  console.error(
    "❌ ERROR: Edita el archivo scripts/sync-solicitudes-status.js y pega tus credenciales."
  );
  process.exit(1);
}
...
async function syncStatuses() {
  ...
  console.log(
    `   - Los datos creados nativamente en Supabase (sin airtable_id) NO fueron tocados.`
  );
}
