...
if (
  ...
  SERVICE_ROLE_KEY.includes("PEGAR_AQUI")
) {
  console.error(
    "❌ ERROR: Edita el archivo scripts/create-users.js y pega las credenciales (VITE_SUPABASE_URL o SUPABASE_SERVICE_ROLE_KEY)."
  );
  process.exit(1);
}
