...
async function forceSyncLinks() {
  ...
  console.log(
    `   👉 Recarga la aplicación. Si Barloqui sigue sin aparecer, verifica que su 'airtable_id' en la tabla 'estudiantes' coincida con el ID que mostró el log de DEBUG.`
  );
}
