...
export const calculateCriterios = (
  ...
  const horasOrientacionElegida = StudentRules.calculateSpecialtyHours(
    allPracticas,
    selectedOrientacion
  );
  ...
  return {
    ...
    horasFaltantesOrientacion: Math.max(
      0,
      config.horasObjetivoOrientacion - horasOrientacionElegida
    ),
