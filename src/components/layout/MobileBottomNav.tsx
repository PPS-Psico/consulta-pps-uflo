        ...
        {tabs.map((tab) => {
          ...
          return (
            ...
            >
              ...
              <div
                className={`transition-all duration-300 ease-out transform ${isActive ? "-translate-y-0.5" : ""}`}
              >
                <div
                  className={`
                ...
                >
                  <span
                    className={`material-icons transition-all duration-300 ${isActive ? "!text-[26px] drop-shadow-sm" : "!text-[24px]"}`}
                  >
                    {tab.icon}
                  </span>
                </div>
