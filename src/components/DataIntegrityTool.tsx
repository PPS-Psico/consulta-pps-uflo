        ...
        try {
            ...
            if (students) {
                ...
                students.forEach((s: any) => {
                    ...
                    const nombre = s[FIELD_NOMBRE_ESTUDIANTES];
                    const correo = s[FIELD_CORREO_ESTUDIANTES];
                    
                    // CRITICAL: Ghost Student
                    if (!legajo) {
                         newIssues.push({
                            id: `st-nolegajo-${s.id}`,
                            ...
                            description: `ID: ${s.id}. No tiene legajo asignado.`,
                            action: 'delete'
                        });
                    } else {
            ...
            if (practicas) {
                practicas.forEach((p: any) => {
                     ...
                     // Check logic would require looking up maps, simplified here assuming simple null checks
                     if (!studentLink && !p[FIELD_NOMBRE_BUSQUEDA_PRACTICAS]) {
                          newIssues.push({
                            ...
                            description: `No está vinculada a ningún estudiante.`,
                            action: 'delete'
                        });
                     }
                });
