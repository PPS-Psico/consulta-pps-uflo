...
const WelcomeBannerSkeleton: React.FC = () => (
  <div className="p-6 sm:p-8 rounded-3xl bg-slate-100 dark:bg-slate-800/50 animate-pulse">
...
const WelcomeBanner: React.FC<WelcomeBannerProps> = ({
  ...
  return (
    <div className="relative p-6 sm:p-8 rounded-3xl border border-slate-200/80 dark:border-slate-700/80 shadow-lg overflow-hidden bg-gradient-to-br from-blue-50/80 via-white/70 to-slate-50/80 dark:from-blue-900/30 dark:via-slate-900/20 dark:to-black/30 backdrop-blur-lg animate-fade-in-up">
      {/* Fondo decorativo */}
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
            <div className="flex-grow">
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-slate-900 dark:text-white tracking-tighter leading-tight">
                  {greeting}, <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400 whitespace-nowrap">
                      {firstName}.
                  </span>
                </h1>
