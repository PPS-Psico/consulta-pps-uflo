...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className={`flex-shrink-0 bg-white dark:bg-slate-800/50 backdrop-blur-sm p-4 rounded-2xl border border-slate-200 dark:border-slate-700/80 shadow-sm ${className}`}>
