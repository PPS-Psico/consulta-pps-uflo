...
const SmartBriefing: React.FC<SmartBriefingProps> = ({ status, summary, insights, score, userName }) => {
    ...
    return (
        <div className="relative w-full overflow-hidden rounded-3xl bg-white dark:bg-[#0F172A] border border-slate-200 dark:border-slate-800 shadow-xl dark:shadow-2xl animate-fade-in-up transition-colors duration-300">
            ...
            <div className="relative z-10 p-6 sm:p-8 flex flex-col lg:flex-row gap-8 items-center lg:items-stretch">
                ...
                <div className="flex-none flex flex-col sm:flex-row items-center gap-6 bg-slate-50/80 dark:bg-slate-900/50 rounded-2xl p-4 border border-slate-200/60 dark:border-slate-800/60 backdrop-blur-sm shadow-sm dark:shadow-inner">
                    ...
                    {/* Action Area */}
                    <div className="flex flex-col justify-center min-w-[210px]">
                        {insights.length > 0 ? (
                            <>
