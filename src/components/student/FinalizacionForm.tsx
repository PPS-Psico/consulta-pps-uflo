          ...
          return (
            ...
            >
              <div className="p-5">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mb-4 pl-1">
                  {section.desc}
                </p>
                ...
                >
                  ...
                  <div className="flex flex-col items-center gap-1">
                    <span
                      className={`material-icons !text-2xl ${isActive ? "text-blue-500" : "text-slate-300 dark:text-slate-600"}`}
                    >
                      cloud_upload
                    </span>
