...
export const MetricsDashboard: React.FC<MetricsDashboardProps> = ({ onStudentSelect, isTestingMode = false }) => {
  ...
  // FIX: Added initial value of 0 to the reduce function to prevent type errors.
        ...
        {isLoading || !metrics ? (
          ...
          <>
            ...
            <HeroMetric
              ...
              onClick={() => openModal({ title: `Alumnos Finalizados (${targetYear})`, students: metrics.alumnosFinalizados.list as StudentInfo[] })}
              color="emerald"
            />
          </>
        )}
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              />
               <MetricCard
                  ...
                  isLoading={isLoading}
                  onClick={() => openModal({ title: `Finalizados en ${targetYear}`, students: metrics.alumnosFinalizados.list as StudentInfo[] })}
              />
            </div>
          )}
