...
const NotaSelector: React.FC<NotaSelectorProps> = ({ onSelect, onClose, currentValue }) => {
  ...
  return (
    <div 
        className="absolute top-full left-1/2 -translate-x-1/2 mt-3 w-40 bg-white dark:bg-slate-800 rounded-xl shadow-2xl border border-slate-200 dark:border-slate-700 overflow-hidden animate-scale-in origin-top z-[100]"
