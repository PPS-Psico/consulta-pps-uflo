...
const PaginationControls: React.FC<PaginationControlsProps> = ({
  ...
  return (
    <div
      className={`flex flex-col sm:flex-row justify-between items-center gap-4 py-4 px-6 border-t border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800/50 ${className}`}
    >
