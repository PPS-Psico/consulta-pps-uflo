...
const LanzadorConvocatorias: React.FC<LanzadorConvocatoriasProps> = ({ forcedTab }) => {
        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-6">
          ...
          <form onSubmit={handleSubmit}>
            ...
            {currentStep === 2 && (
              <div className="space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <Step2Detalles formData={formData} onChange={handleInputChange} />
                </div>
            ...
            <div className="flex justify-between mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
              <Button variant="secondary" onClick={() => setFormData(initialState)} type="button">
                Limpiar Formulario
              </Button>
