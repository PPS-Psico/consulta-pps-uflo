...
const Loader: React.FC = () => {
  ...
  return (
    <div 
      ...
      style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', margin: '3rem 0', width: '100%' }}
    >
      <div 
      ...
      ></div>
      <span className="sr-only" style={{ position: 'absolute', width: '1px', height: '1px', overflow: 'hidden' }}>Cargando...</span>
    </div>
  );
};
