...
export const mapFieldsToDb = (_tableName: string, fields: Record<string, any>): Record<string, any> => fields;
export const mapDbRowToFields = (_tableName: string, row: Record<string, any>): Record<string, any> => row;
